const quizData = {
  french: [
    ...
    },
    {
      ...
      answer: "Ngày 23-9-1945, thực dân Pháp đánh úp trụ sở ủy ban nhân dân Nam Bộ"
    },
    
    {
      question: "Cuộc kháng chiến toàn quốc chống thực dân Pháp bắt đầu từ ngày nào?",
      options: ["Ngày 18-12-1946", "Đêm 19-12-1946", "Đêm 20-12-1946", "Ngày 22-12-1946"],
      answer: "Đêm 19-12-1946"
    },
    
    {
      question: "Đường lối kháng chiến chống thực dân Pháp thể hiện trong các sự kiện lịch sử nào?",
      options: ["Lời kêu gọi toàn quốc kháng chiến của Chủ tịch Hồ Chí Minh (19-12-1946)", "Chỉ thị Toàn dân kháng chiến của ban thường vụ Trung ương Đảng (22-12-1946)", "Tác phẩm Kháng chiến nhất định thắng lợi của Trường Chinh (9-1947)", "Tất cả các văn kiện trên"],
      answer: "Tất cả các văn kiện trên"
    },
    
    {
      question: "Thực dân Pháp gọi đường nào là 'con đường chết'?",
      options: ["Đường số 3", "Đường số 4", "Đường quốc lộ 1 (đoạn Bắc Giang - Lạng Sơn)", "Đường số 5 Hà Nội - Hải Phòng"],
      answer: "Đường số 4"
    },
    
    {
      question: "Hành động nghiêm trọng, trắng trợn nhất thể hiện thực dân Pháp đã bội ước tiến công ta?",
...
{
  question: "Sự kiện nào sau đây là nguyên nhân làm cho Đảng ta thay đổi chiến lược từ hoà hoãn với Tưởng để chống Pháp sang hoà hoãn với Pháp để đuổi Tưởng?",
  options: ["Quốc hội khoá 1 (2-3-1946) chủ trương cho Tưởng một số ghế trong Quốc hội", "Hiệp ước Hoa - Pháp (28-2-1946)", "Hiệp định sơ bộ Việt - Pháp (6-3-1946)", "Tạm ước Việt - Pháp (14-9-1946)"],
  answer: "Hiệp ước Hoa - Pháp (28-2-1946)"
},
{
...
},
{
  ...
  options: ["Năm 1945", "Năm 1946", "Năm 1949", "Năm 1950"],
  answer: "Năm 1946"
  },
  
  {
  question: "Chiến dịch chủ động tiến công lớn đầu tiên của bộ đội chủ lực Việt Nam trong cuộc kháng chiến chống thực dân Pháp (1945-1954) là chiến dịch nào?",
  options: ["Chiến dịch Thượng Lào (1953)", "Chiến dịch Việt Bắc thu-đông (1947)", "Chiến dịch Hòa Bình đông-xuân (1951-1952)", "Chiến dịch Biên giới thu-đông (1950)"],
  ...
  american: [
    // AMERICAN (Các câu hỏi về thời kỳ chống Mỹ)

{
  question: "Học thuyết nào đã chi phối việc đế quốc Mĩ quyết tâm theo đuổi cuộc chiến tranh Việt Nam (1954-1975) để ngăn chặn làn sóng cộng sản tràn xuống phía Nam?",
  options: ["Học thuyết Truman", "Học thuyết Domino", "Học thuyết Kenedy", "Học thuyết Nixon"],
  answer: "Học thuyết Domino"
},

{
  question: "Trong những năm 1954-1975, Việt Nam là một trong những trọng điểm trong chiến lược nào của đế quốc Mĩ?",
  options: ["Chiến lược toàn cầu", "Thực dân kiểu mới", "Trả đũa ồ ạt", "Phản ứng linh hoạt"],
  answer: "Chiến lược toàn cầu"
},

{
  question: "Đâu không phải là âm mưu của đế quốc Mĩ từ năm 1954-1975 khi thay chân Pháp ở miền Nam Việt Nam?",
  options: ["Chia cắt lâu dài Việt Nam", "Biến miền Nam thành thuộc địa kiểu mới, căn cứ quân sự của Mĩ ở Đông Dương", "Làm bàn đạp tấn công ra miền Bắc để tiêu diệt chủ nghĩa cộng sản", "Thúc đẩy sự giàu mạnh của miền Nam để đối trọng với miền Bắc"],
  answer: "Thúc đẩy sự giàu mạnh của miền Nam để đối trọng với miền Bắc"
},

{
  question: "Kẻ thù trực tiếp của nhân dân miền Nam sau hiệp định Giơnevơ năm 1954 về Đông Dương là",
  options: ["Đế quốc Mĩ", "Thực dân Pháp", "Chính quyền tay sai Ngô Đình Diệm", "Mĩ và chính quyền Ngô Đình Diệm"],
  answer: "Mĩ và chính quyền Ngô Đình Diệm"
},

{
  question: "'Nhanh chóng tạo ra ưu thế về binh lực và hỏa lực có thể áp đảo quân chủ lực của ta bằng chiến lược quân sự mới tìm diệt, cố giành lại thế chủ động trên chiến trường' là âm mưu của Mĩ trong chiến lược quân sự nào?",
  options: ["Chiến tranh đơn phương", "Chiến tranh đặc biệt", "Chiến tranh cục bộ", "Việt Nam hóa chiến tranh"],
  answer: "Chiến tranh cục bộ"
},

{
  question: "Lực lượng quân sự nào giữ vai trò nòng cốt trong chiến lược 'chiến tranh cục bộ' của Mĩ thực hiện ở miền Nam Việt Nam (1965-1968)?",
  options: ["Quân đội Mĩ", "Quân đội Việt Nam Cộng hòa", "Quân đồng minh của Mĩ", "Quân Mĩ và quân đồng minh của Mĩ"],
  answer: "Quân đội Mĩ"
},

{
  question: "Thủ đoạn chính của Mĩ trong chiến lược 'chiến tranh cục bộ' ở miền Nam Việt Nam (1965-1968) là",
  options: ["Tìm diệt", "Càn quét", "Dồn dân lập ấp chiến lược", "Tìm diệt và bình định"],
  answer: "Tìm diệt và bình định"
},

{
  question: "Nội dung nào không phải là biện pháp của Mỹ khi triển khai thực hiện chiến lược 'Chiến tranh cục bộ' (1965-1968) ở miền Nam Việt Nam?",
  options: ["Ồ ạt đưa quân Mỹ và đồng minh Mỹ vào miền Nam Việt Nam", "Tiến hành chiến tranh phá hoại miền Bắc Việt Nam lần thứ nhất", "Rút dần quân Mỹ và đồng minh khỏi chiến trường miền Nam", "Mở các cuộc hành quân tấn công vào vùng 'đất thánh Việt cộng'"],
  answer: "Rút dần quân Mỹ và đồng minh khỏi chiến trường miền Nam"
},

{
  question: "Vì sao Mĩ lại thực hiện chiến lược 'chiến tranh cục bộ' ở miền Nam Việt Nam trong những năm 1965-1968?",
  options: ["Do thất bại của chiến lược 'Chiến tranh đơn phương'", "Do tác động của cuộc Tổng tiến công và nổi dậy Xuân Mậu Thân 1968", "Do tác động của phong trào 'Đồng Khởi'", "Do thất bại của 'Chiến lược chiến tranh đặc biệt'"],
  answer: "Do thất bại của 'Chiến lược chiến tranh đặc biệt'"
},

{
  question: "Trong cuộc kháng chiến chống Mỹ (1954-1975), cuộc chiến đấu nào của quân dân miền Nam đã buộc Mĩ phải 'phi Mĩ hóa' chiến tranh xâm lược?",
  options: ["Trận 'Điện Biên Phủ trên không' năm 1972", "Phong trào 'Đồng khởi' năm 1959-1960", "Cuộc Tổng tiến công và nổi dậy xuân Mậu Thân năm 1968", "Cuộc Tiến công chiến lược năm 1972"],
  answer: "Cuộc Tổng tiến công và nổi dậy xuân Mậu Thân năm 1968"
},

{
  question: "Thắng lợi nào của ta trong cuộc kháng chiến chống Mỹ (1954-1975) buộc Mỹ phải chấp nhận ngồi vào bàn đàm phán tại hội nghị Paris?",
  options: ["Thắng lợi của cuộc tổng tiến công và nổi dậy xuân Mậu Thân 1968", "Thắng lợi của trận Điện Biên Phủ trên không (12/1972)", "Thắng lợi của quân dân Việt Lào (1971)", "Thắng lợi của cuộc tiến công chiến lược 1972"],
  answer: "Thắng lợi của cuộc tổng tiến công và nổi dậy xuân Mậu Thân 1968"
},

{
  question: "Ngày 31-3-1968, bất chấp sự phản đối của chính quyền Sài Gòn, Tổng thống Mỹ Giônxơn tuyên bố ngừng ném bom miền Bắc Việt Nam từ vĩ tuyến 20 trở ra. Điều này chứng tỏ điều gì?",
  options: ["Làm cho ý chí xâm lược của đế quốc Mỹ ở Việt Nam bị sụp đổ hoàn toàn", "Làm khủng hoảng sâu sắc hơn quan hệ giữa Mỹ và chính quyền Sài Gòn", "Buộc Mỹ phải giảm viện trợ cho chính quyền và quân đội Sài Gòn", "Buộc Mỹ phải xuống thang trong chiến tranh xâm lược Việt Nam"],
  answer: "Buộc Mỹ phải xuống thang trong chiến tranh xâm lược Việt Nam"
},
